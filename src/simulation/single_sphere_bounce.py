...
from src.config import load_sim_config  # ✅ Import config loader
import imageio  # For recording
...
record_video = False
obj = 'sphere'  # Fixed for this simulation
...
# --- Load and modify the XML model with dynamic timestep and incline angle ---
...
# ✅ Set initial angular and linear velocities
...
while not glfw.window_should_close(window):
    ...
    # Capture frame if recording enabled
...
# --- Save plots and finalize recording ---
